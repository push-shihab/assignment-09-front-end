...
const EditRoom = ({ room }) => {
  ...
  return (
    <div>
      <button
        className="flex-1 btn btn-sm bg-[#3a3a1a] hover:bg-[#4a4a2a] border border-[#5a5a2a] text-yellow-300 rounded-lg normal-case"
        onClick={() =>
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-[#f0b429]">Edit Room</h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#111111] border border-[#2e2e2e] rounded-lg px-4 py-2.5 text-[#eeeeee] text-sm placeholder-[#666666] focus:outline-none focus:border-[#f0b429] transition-colors"
                    {...register("name")}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#111111] border border-[#2e2e2e] rounded-lg px-4 py-2.5 text-[#eeeeee] text-sm placeholder-[#666666] focus:outline-none focus:border-[#f0b429] transition-colors resize-y"
