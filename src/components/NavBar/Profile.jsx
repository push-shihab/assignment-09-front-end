...
const Profile = ({ session, revalidatePathForLogout }) => {
  ...
  return (
    ...
    >
      <button className="flex items-center gap-2 md:gap-3 px-2 py-2 md:px-4 rounded-full bg-[#1a1a1a] border border-white/10 hover:border-[#D97757]/50 transition-all duration-300 shadow-lg group cursor-pointer">
      ...
      <div className="z-40 absolute right-0 sm:left-0 pt-3 w-64 md:w-72 bg-transparent">
        <div
          className={`rounded-2xl bg-[#1a1a1a] border border-white/10 shadow-2xl shadow-black/60 overflow-hidden transition-all duration-300 origin-top ${
            open
